...
class NotificationFragment : Fragment() {
    ...
    private fun setupView() {
        ...
        weekdayAdapter.onBtnWeekdayClickListener = View.OnClickListener { view ->
            val position = view.tag as Int
            weekdayAdapter.weekdays[position].let { weekday ->
                rvMessageGroup?.smoothScrollToPosition(position)
            }
        }
